...
void Document::InitDOMSecurityPolicy(
	DOMSecurityPolicy* dsp) {
	LOG(INFO) << "I am in Document.cpp::InitDOMSecurityPolicy() ";
	SetDOMSecurityPolicy(dsp ? dsp : DOMSecurityPolicy::Create());
	GetDOMSecurityPolicy()->BindToExecutionContext(this);
}
/* End DOM Policy Code */
